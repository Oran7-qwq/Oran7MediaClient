...
Rectangle {
    ...
    ListModel {
        id: topListModel
        ListElement {
            iconImage: "qrc:/image/suggest.png"
            iconText: "VideoPlayer??"
            pageName: "VideoPlayerPage"
        }
        ListElement {
            iconImage: "qrc:/image/speSeleted.png"
            iconText: "ScreenCpature??"
            pageName: "ScreenCapturePage"
        }
        ListElement {
            iconImage: "qrc:/image/bok.png"
            iconText: "NAME??"
            pageName: "NAME?1"
        }
        ListElement {
            iconImage: "qrc:/image/gz.png"
            iconText: "NAME??"
            pageName: "NAME?2"
        }
    }
    ...
    ListModel {
        ...
        ListElement {
            iconImage: "qrc:/image/localmusic.png"
            iconText: "本地音乐"
