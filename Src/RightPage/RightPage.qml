...
Rectangle {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            // 创建从右下到左上的渐变
            var gradient = ctx.createLinearGradient(width, height, 0, 0);
            ...
            if (endPos > startPos) {
                ...
                for (var i = 0; i <= 10; i++) {
                    ...
                    // 转换为CSS颜色
                    var mixedColor = "#" + r.toString(16).padStart(2, '0') + g.toString(16).padStart(2, '0') + b.toString(16).padStart(2, '0');
    ...
    MainStackView {
        ...
        initialItem: Qt.createComponent("qrc:/Src/RightPage/MainStackView/VideoPlayerStack.qml").createObject(mainStackView, {
