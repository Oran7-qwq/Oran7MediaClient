...
struct qt_meta_stringdata_CLASSFileHelperENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFileHelperENDCLASS = QtMocHelpers::stringData(
    "FileHelper",
    "fileExists",
    "",
    "filePath"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFileHelperENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FileHelper::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFileHelperENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFileHelperENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFileHelperENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void FileHelper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: { bool _r = _t->fileExists((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
...
void *FileHelper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFileHelperENDCLASS.stringdata0))
